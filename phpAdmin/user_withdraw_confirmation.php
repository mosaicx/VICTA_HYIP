<?php
	...
	if(isset($_SESSION["ADMIN_ID"])){
		...
		if($AdminUserHandler->getRecordCount() > 0){
			...
			$WithdrawalHandler->SelectGlobalPendingWithdrawals(); 
			$pendingWithdrawals = $WithdrawalHandler->getRecordsTable();
			if(isset($_POST["confirmSubmit"])){
				if($WithdrawalHandler->updateWithdrawalStatus($_POST['tx_id'], $AdminUID)){
					header("Location: user_withdraw_confirmation.php");
					$bankDetailsMsg = 'Withdrawal confirmed.';
				}else{
					$bankDetailsMsg = 'Failed to confirm withdrawal';
				}
			}
		}else{
...
<body>
	...
	<div class="w3l-banner">
		...
		<div class="features">
		<div class="container">
			<h3>Bank Withdrawal Confirmation</h3>
					...
					<div id="myTabContent" class="tab-content">
						<div role="tabpanel" class="tab-pane fade active in" id="home" aria-labelledby="home-tab">
							<div class="w3agile_tabs">
								<div class="col-md-7 w3agile_tab_left contact-w3-agileits">
									<h4>Confirm User Withdrawals</h4>
									<p>
										<table class="withdrawals_table" >
											<tr>
											<th width="180"> Transaction  Date </th>
											<th width="180"> Transaction  Amount </th>
											<th width="180"> Transaction  Status </th>
											<th width="180"> Transaction  ID </th>
											<th width="180"> Transaction  Reference </th>
											<th width="180"> Admin Action</th></tr>
											<?php 
						...
						<div role="tabpanel" class="tab-pane fade" id="Feature3" aria-labelledby="Feature3-tab"><div class="w3agile_tabs">
								<div class="col-md-7 w3agile_tab_left">
									...
									<p>
										Cras consectetur tempus lectus id accumsan. Vivamus gravida justo mattis ex pretium, eu sollicitudin tortor ullamcorper. Quisque vitae diam molestie, tincidunt velit vitae, viverra nisl. Mauris ultrices commodo imperdiet. In urna odio, semper nec est non, pulvinar molestie quam. Etiam egestas varius nunc et rutrum. Curabitur tempor lacinia pharetra. Ut laoreet urna sed risus consequat laoreet. In volutpat sollicitudin volutpat. eget auctor eros 
										ultrices. Vestibulum non erat ut odio euismod accumsan. 
										Phasellus libero tellus, pulvinar vitae sem sit amet, 
										faucibus consectetur neque.
									</p>
